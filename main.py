...
# SECCIÓN 5: FUNCION QUE PERMITE ELIMINAR TILDES
# La usamos para eliminar las tildes de una palabra y poder validarla
...
# SECCIÓN 6: FUNCIÓN PARA AGREGAR UN PAÍS
...
def agregar_pais(lista_de_paises):
    ...
    if continente == "":
        ...
        continentes_validos = ["América","África","Oceanía","Europa","Asia"]
        for p in continentes_validos:
            if quitartildes(continente).lower() == quitartildes(p).lower():
                continente = p
                break
        if not continente in continentes_validos:
...
# SECCIÓN 7: FUNCIÓN PARA ACTUALIZAR POBLACIÓN Y SUPERFICIE
...
# SECCIÓN 8: FUNCIÓN PARA BUSCAR UN PAÍS POR NOMBRE
...
# SECCIÓN 9: FUNCIONES DE FILTRADO
...
# SECCIÓN 10: FUNCIONES AUXILIARES PARA ORDENAMIENTO
...
# SECCIÓN 11: FUNCIÓN DE ESTADÍSTICAS
...
# SECCIÓN 12: FUNCIÓN PARA LISTAR TODOS LOS PAÍSES
...
# SECCIÓN 13: FUNCIÓN DEL MENÚ PRINCIPAL
...
# SECCIÓN 14: FUNCIÓN PRINCIPAL (MAIN)
...
# SECCIÓN 15: PUNTO DE ENTRADA DEL SCRIPT
